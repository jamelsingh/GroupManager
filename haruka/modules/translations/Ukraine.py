...
UkrainianStrings = {
    ...
    "Could not demote. I might not be admin, or the admin status was appointed by another user, so I can't act upon them!": "Я не можу знизити. Можливо я не адмін, чи статус адміністратора був був призначений іншим користувачем, тому я не можу знизити його!",
    ...
    " (Creator)": " (Створювач)",
    "You don't seem to be referring to a user.": "Здається, ви звертаєтесь не до користувача.",
    "RUNS-K": RUN_STRINGS,
    ...
    "Invalid Chat ID provided!": "ID чату не існує!",
...
*Тільки адміни:*
 ...
 - /welcomesecurity <off/soft/hard>: soft - заборонити користувачу відправляти медіафайли протягом 24 годин, hard - заборонити користувачу віправляти повідомлення, поки він не натисне кнопку \"Я не бот\".""".format(
